export default async function handler(req, res) {
  ...
  // Resend API Key (folosim prima cheie cu Full Access pe care o ai în cont)
  const RESEND_API_KEY = process.resend_api_key || 're_dRVftoDE_...'; // Pune aici cheia ta completă
  ...
  try {
    const response = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'V8 Power Garage <v8powergarage@gmail.com>',
        to: [clientEmail],
